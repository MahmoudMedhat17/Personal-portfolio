...
export const projectLinks = [
  {
    img: "/Shopcart.png",
    title: "ShopCart",
    desc: "A modern and responsive e-commerce website built to provide users with a smooth online shopping experience. The platform allows users to browse products, explore categories, view detailed product information, manage their shopping cart, and complete the purchasing process through an intuitive and responsive interface.",
    techStack: [
      {
      ...
      {
        icon: <img src="/zustand.svg" width={30} height={30} />,
        title: "Zustand",
      },
      {
    ...
    live: "https://shopcart-ecommerce-site-sooty.vercel.app/client",
    repo: "https://github.com/MahmoudMedhat17/Shopcart-ecommerce-site",
  },
  {
    img: "/Femex.png",
    title: "Femex",
